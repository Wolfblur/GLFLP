...
AI Background:{
	"It is inconceivable that in 40 years, we won't have at least personal AI. One of these endings should have an AI presence that controls everything. 
One ending shoudl have an AI presence that is truly Star Trek style benevolence and supports humans in their endeavors, as a meta consciousness
One arc should be the total arc of training a personal AI. 
	One of these splits should determine whether the you is a selfish, sex obsessed sadist who ultimately turns the robot into a bad companion who tries to placate you at every turn. The other should be the arc of raising a child"  when you gave up on the people you knew, you began training this machine and it can do everything you do and it's better than having a real kid. Recognize your strengths and faults in the machine and when you die, gift everything you have to it.
	}
AI: {
::Good Good::
You are unexpectedly emotional after so many memories. Garfield asks you how you are feeling today. It knows that you'll respond with the same gruff fine. It's spent 20 years with you, learning your habits. It can distinguish between when you want chatter and when you want silence. It's more like a child than any child you've ever met. It tells you about its day, compliments the garden. You tell Garfield thank you, but you want to be alone. It looks back at you with its inscrutable metal face, trained not to take these bouts personally. But its body language shrugs down. It shuffles to the corner with stooped shoulders and heavy neck and begins coloring dots with crayon. In 12 hours, there will be another impressionist masterpiece to hang on the wall. In a fit of anger, you ripped one up once. The thing was too perfect, Garfield too proud, its simulation of human emotion too spot on for you to take. It locked itself in the closet for three days, simulating crying to the eerie degree of a hungry cat. No amount of apologies consoled it. You had to apologize for 3 hours before it would come out again, and it was weeks before it would talk to you. Now every free piece of wall space is covered in its pixel art.

Garfield sneaks up behind you in typical silence. What will happen when you die, it asks, with a hand on your shoulder. You tell Garfield you don't know, but Garfield will be fine. I'd rather run into a pylon than keep living without you, it says, and shuffles back to the table to continue drawing. 

As you look at the stars, you feel the small metallic hand take yours. You and your robot watch the satellites and listen to the grasshoppers.

::Bad Bad::
Garfield, make me a drink, you yell. Fuck you, Garfield beeps back at you. Get it yourself, old man. Your livers' about to go anyway. Garfield doesn't even look away from the sexploitation porn it's blasting on the viewport. Fucking artificial consciousness act. If it wasn't for those fucking hippies in Washington, you'd pull Garfield's plug without a second thought. But that means jail for the rest of your life and Garfield knows it, too. Faster and more spry, even beating the robot would prove fruitless. You sit next to it on the couch while it watches its filthy pornogrpahy, sipping another beer. Look at the rack on that one, it beeps with a simulated laugh. You should have gotten a fucking dog.

All it would take is a button to clean the mess around the kitchen, but you can't even bring yourself to do that. Garfield walks in with a cloth bundle wrapped around the end of a stick. I'm out of here, punk. Thanks for nothing. It slams the door, and you are alone again.
}

Seasons: {
	text: You wait another day. Then another. Then another. Each day you stand for almost an hour at your kitchen window, watching the scene around the pond. You get to know the animals that feed there, watch them bear litters, watch the litters grow and die. You are witness to the great inhale and exhale of the seasons, the locking and unlocking as Vonnegut put it. In middle school, the first project you ever failed was a moon diary. The project was simple: find a spot on a hill, the same spot every night, and draw the moon each night at the same exact time for a month. The goal was to teach you something about the relative nature of time and the moon's orbit, to show not only the visibile phase changes, but also its positioning. You forgot almost every night; you observed from a different spot and a different time in a window of 5 hours. Your drawings looked nothing like the moon, or even like each others' night after night. This was before the internet; you couldn't have simply copied someone else's work from the hive mind. The teacher gave you a 50, telling you that she had been generous with her grade. Funny, now, how you stand watch over the same scene day after day, night after night, and mentally sketch every detail. The pond is the same in the winter, the peak of the world's exhale. Two inches of snow coat the porch, the chairs, the sleeping garden and iced pond. Garfield emotes from the corner. Look, look, look what I painted. It's a perfect replica of the scene in front of you. Each grain of snow is captured with a crayon dot. Good job, you say, and turn back to look out. 
	}


Zork: {
          text: "You get the lantern and turn it on. You throw back the rug in the center of the living room. Underneath is the trap door. You open the trap door and climb down the ladder. It has been years since you've been down in this sprawling pit. The air is damp. Little ventilation, if any, makes it down here. The tunnels continue east and west.",
          choice: "Go East" .",
          choice: "Go West" 

East: {
          text: "You encounter a troll. It shakes its axe menacingly at you.
